		...
		<article>
			<div class="container-fluid">
		      <div class="row">
		          ...
		          <h1 class="page-header">已删除博文列表</h1>
		              ...
		              <tbody>
		              	<c:forEach var="blog" items="${pagedBlogs.result}">
			                  ...
			                  <td>
			                  	...
			                  	<a href="<c:url value='/admin/noDeleteBlog.htm'/>?blogId=${blog.blogId }" onclick="javascript:if(confirm('确定要取消删除此博文吗？')){return true;}return false;">取消删除</a>
			                  </td>
			                </tr>
		                </c:forEach>
		              </tbody>
