		...
		<article>
			<div class="container-fluid">
		      ...
		      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		          <h1 class="page-header">新增博文</h1>
		          <div class="row placeholders">
		            <form action="<c:url value='/admin/addBlog.htm'/>" method="post" onsubmit="return checka(this)">
		            	<span>博文名称：</span><input type="text" name="blogTitle" class="form-control" size="100px"/><br /><br />
		            	<span>所属分类：</span><select class="form-control" id="top-classification"  onChange="getSecondClassification();"><option value="0">请选择</option></select>&nbsp;&nbsp;&nbsp;
						...
						<div style="padding-left:40px;">
							<c:forEach var="tag" items="${tags}">
								<label class="tag"><input value="${tag.tagId }" type="checkbox" name="tag" >${tag.tagName}</label>&nbsp;&nbsp;&nbsp;&nbsp;
							</c:forEach>
						</div>
						<br/>
