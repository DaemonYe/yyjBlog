		...
		$(document).ready(function() {  
			$.getJSON("<c:url value='/linkage.htm'/>?classificationId=", "", function(response){  
	            $.each(response,function(i){   
	            	if(response[i].id==${classification.parentId.classificationId }){
		...
		<article>
			<div class="container-fluid">
		      ...
		      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		          <h1 class="page-header">更改二级分类</h1>
		          <div class="row placeholders">
		            <form action="<c:url value='/admin/updateSecondClassification.htm'/>" method="post">
		            	<input type="hidden" name="classificationId" value="${classification.classificationId}">
		            	<span>二级分类名称：</span><input type="text" name="classificationName" class="form-control" value="${classification.classificationName }"/><br /><br />
		            	<span>所属分类：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		            	<select class="form-control" id="top-classification" name="parentId.classificationId"><option value="0">请选择</option></select><br /><br />
		            	<span class="classification-span">二级分类描述：</span><textarea class="form-control classification-textarea" name="classificationDesc" >${classification.classificationDesc }</textarea>
						<br /><br />
