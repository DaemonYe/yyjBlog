		...
		<article>
			<div class="container-fluid">
		      ...
		      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		          <h1 class="page-header">更新一级分类</h1>
		          <div class="row placeholders">
		            <form action="<c:url value='/admin/updateTopClassification.htm'/>" method="post" onsubmit="return checka(this)">
		            	<input type="hidden" name="classificationId" value="${classification.classificationId}">
		            	<span>一级分类名称：</span><input type="text" name="classificationName" class="form-control" value="${classification.classificationName} "/><br /><br />
		            	<span class="classification-span">一级分类描述：</span><textarea class="form-control classification-textarea" name="classificationDesc" >${classification.classificationDesc }</textarea>
						<br /><br />
